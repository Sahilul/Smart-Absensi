                    ...
                    <div class="class-card rounded-xl border border-white/20 shadow-md overflow-hidden card-hover group animate-slide-up"
                        ...
                        <div class="p-4">
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-200">
                                ...
                                <div class="seg-actions grid grid-cols-1 sm:grid-cols-3 gap-3">
                                    <!-- Harian -->
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-200">
                                <div class="flex items-center mb-3">
                                    <i data-lucide="menu" class="w-4 h-4 mr-1.5 text-secondary-400"></i>
                                    <span class="text-xs font-bold text-secondary-600 uppercase tracking-wider">Menu Lainnya</span>
                                </div>
                                <div class="seg-actions grid grid-cols-1 sm:grid-cols-3 gap-3">
                                    <!-- Detail -->
                                    ...
                                    <!-- Cetak -->
                                    <button onclick="printPenugasan('<?= $pid; ?>')" class="seg-btn seg-dark" title="Cetak">
                                        <div class="seg-left">
                                            <span class="seg-icon">
                                                <i data-lucide="printer" class="w-5 h-5"></i>
                                            </span>
                                            <span class="seg-label">Cetak</span>
                                        </div>
                                        <i data-lucide="chevron-right" class="w-4 h-4 seg-right"></i>
                                    </button>
                                </div>
